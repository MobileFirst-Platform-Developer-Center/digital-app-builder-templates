...
class List extends React.Component {
  ...
  renderList() {
    ...
    this.itemList.map((item, index) => {
      let backgroundStyle = styles.itemContainerOneBg;
      let itemColor = '#3c4956';
      if ((index + 1) % 2 === 0) {
        backgroundStyle = styles.itemContainerTwoBg;
        itemColor = '#322f3e';
      } else if ((index + 1) % 3 === 0) {
        backgroundStyle = styles.itemContainerThreeBg;
        itemColor = '#2c364d';
      }
      renderList.push(
        <View style={styles.itemParent} key={index}>
          <TouchableOpacity
            activeOpacity={0.9}
            onPress={() =>
            ...
            style={[styles.item]}
          >
            <View style={[styles.itemContainer, backgroundStyle]}>
